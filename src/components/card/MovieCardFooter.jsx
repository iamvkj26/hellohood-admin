...
const MovieCardFooter = ({ movie, onWatched }) => {
    ...
    return (
        <div className="card-footer d-flex justify-content-end align-items-end cp-n">
            {(role === "dev" || role === "admin") ?
                <div className="form-check mt-1 mb-1">
                    <input className="form-check-input cp" type="checkbox" checked={movie.msWatched} onChange={onWatched} />
